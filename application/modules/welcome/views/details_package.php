...
<body>
    ...
    <div class="container mt-4">
        <div class="jumbotron text-center">
            ...
            <p>Sebelum Anda Membeli Marchendise dari Toko Kami, Sebaiknya Anda Melengkapi Formulir dibawah</p>
            ...
            <form id="payment-form" method="post" action="<?= site_url() ?>/snap/finish">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" name="email" id="email" aria-describedby="emailHelp" value="guest@gmail.com" placeholder="Enter email" required>
